#' Bream bioenergetic population model
#'
#' Solves the bioenergetic balance for Sea Bream and simulates a population
#'
...
# Post-process data
out_post<-Bream_pop_post(userpath, out_RKsolver, times, Dates,N)
