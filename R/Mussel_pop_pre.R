...
currentpath=getwd()
filepath=paste0(userpath,"/Mussel_population/Inputs/Forcings_plots//TSS.jpeg")
jpeg(filepath,800,600)
days <- seq(as.Date(Dates[1], format = "%d/%m/%Y"), by = "days", length = tf-ti+1)
...
output=list(Param, times, Dates, IC, Tint, Phyint, DTint, POCint, Ccont, Ncont, Pcont, POMint, TSSint,N)
