...
Clam_ind_equations <- function(Param, Tint, Phy, DT, POCint, POMint, TSSint, Wd){
...
filt=CRmax*fa*Wd^q   # Actual filtration rate[l/d]
...
return(output) # Clam_ind_equations output
}
