...
# Plot weight
filepath=paste0(userpath,"/ClamF_population/Outputs/Out_plots//Dryweight.jpeg")
...
filepath=paste0(userpath,"/ClamF_population/Outputs/Out_plots//Tfun.jpeg")
jpeg(filepath,800,600)
...
filepath=paste0(userpath,"/ClamF_population/Outputs/Out_csv//Dryweight.csv")
write.csv(t(WdSave),filepath)

filepath=paste0(userpath,"/ClamF_population/Outputs/Out_csv//Wetweight.csv")
...
filepath=paste0(userpath,"/ClamF_population/Outputs/Out_csv//Days_to_comercial_size.csv")
