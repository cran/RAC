...
Bass_pop_post<-function(userpath,output,times,Dates,N,CS) {
  ...
  # plot excretion
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//excretion.jpeg")
  jpeg(filepath,800,600)
  ...
  # plot wasted food
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//waste.jpeg")
  jpeg(filepath,800,600)
  ...
  # plot ingested food
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//ingestion.jpeg")
  jpeg(filepath,800,600)
  ...
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_plots//Tfun.jpeg")
  jpeg(filepath,800,600)
  ...
  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//Pexc.csv")
  write.csv(PexcSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//Lexc.csv")
  write.csv(LexcSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//Cexc.csv")
  write.csv(CexcSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//Pwst.csv")
  write.csv(PwstSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//Lwst.csv")
  write.csv(LwstSave,filepath)

  filepath=paste0(userpath,"/Bass_population/Outputs/Out_csv//Cwst.csv")
